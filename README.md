...
`CMakeLists.txt` и `.pro` файлы доступны в репозитории. Ниже приведены скрипты сборки (`CMake`) с использованием командной строки.
...
Тогда выполнив в двух из них команды:
...
- GCC 7 или выше
- Make
- Python 3 (с модулями`tkinter` и `xml.etree.ElementTree`)
